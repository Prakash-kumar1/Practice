...
let getInfo = function(place ,job,package , char = "joyful") {
    console.log(` ${this.name} is ${this.age} years old. I'm from ${place} . I'm a ${job} in microsoft with the 
    package of ${package} as a Fresher. I am ${char}`) ;                
};
...
let getInform = function(place ,job,package , char = "notorious") {
    ...
    with the package of ${package} as a Fresher. I am ${char}`) ;                
};
...
let getInformation = function(place ,job,package , char = "notorious") {
    console.log(` ${this.name} is ${this.age} years old. I'm from ${place} . I'm a ${job} in Tesla
     with the package of ${package} as a Fresher. I am ${char}`) ;                
};
...
let getInformation1 = function(place ,job,package, food, char ="naughty and Fool" ) {
    console.log(` ${this.name} profession is a ${this.profession} . I'm from ${place} . 
    I'm a ${job} in Google with the package of ${package} as a Fresher. I am ${char} in nature ,
